export const services = [
  ...
  },
  {
    ...
    alt: 'foto de manicura semipermanente',
  },
  {
    title: 'Manicure Acrílico',
    description: 'Son aquellas que se realizan desde cero con acrílico en polvo (polímero) y acrílico líquido (montonero) ideal para aquellas con uñas débiles quebradizas y o mordidas. 21 días de uñas perfectas con Nice Nails!!',
    image: '/acrilico.png',
